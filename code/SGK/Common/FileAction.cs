...
{
    public class FileAction : Controller
    {
        /// <summary>
        /// Excel文件导成Datatable
        /// </summary>
        ...
        public static DataTable XlSToDataTable(string strFilePath, string strTableName, int iSheetIndex)
        {
            ...
            {
                using (FileStream file = new FileStream(strFilePath, FileMode.Open, FileAccess.Read, FileShare.Read))
                {
                    IWorkbook workbook = null;
                    if (strFilePath.IndexOf(".xlsx") > 0) // 2007版本
                        workbook = new XSSFWorkbook(file);
                    else if (strFilePath.IndexOf(".xls") > 0) // 2003版本
                                ...
                                case CellType.Formula:
                                    switch (item.CachedFormulaResultType)
                                    {
                                        ...
                                        case CellType.Numeric:
                                            if (NPOI.SS.UserModel.DateUtil.IsCellDateFormatted(item))
                                            {
